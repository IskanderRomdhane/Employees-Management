...
const Root = () => {
  return (
    <div>
      ...
      <div
        className="relative flex flex-wrap justify-center items-center py-10 px-10"
        style={{
      ...
      >
        <div className="flex flex-wrap justify-center items-center py-5 px-10 bg-opacity-60">
          ...
          <div className='hidden lg:flex py-10 items-center justify-center rounded-full ml-[100px]'>
            <img
      ...
      <section className="py-20 bg-white" id='features'>
        <h3 className="font-palanquin text-center text-4xl font-bold mb-8">
          Key <span className="text-coral-red">Features</span>
        </h3>
        <div className="flex flex-nowrap justify-center items-center gap-10 max-w-12xl mx-auto px-4">
          <div className="flex flex-col items-center text-center w-72 h-60 p-6 bg-white shadow-lg rounded-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
          ...
          <div className="flex flex-col items-center text-center w-72 h-60 p-6 bg-white shadow-lg rounded-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h4 className="text-xl font-semibold mb-4">Advanced Reporting</h4>
            <p className="text-gray-600">
          ...
          <div className="flex flex-col items-center text-center w-72 h-60 p-6 bg-white shadow-lg rounded-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
            ...
            <h4 className="text-xl font-semibold mb-4">Customizable Notifications</h4>
            <p className="text-gray-600">
      ...
      <section className="py-20 bg-white" id='why-us'>
        ...
        <div className="flex flex-wrap justify-center gap-10 max-w-4xl mx-auto px-4">
          <div className="flex items-center gap-4">
            <FaChartLine className="text-3xl text-blue-500" />
            <p className="text-gray-700 text-lg">Increased productivity</p>
          </div>

          <div className="flex items-center gap-4">
            <FaDollarSign className="text-3xl text-green-500" />
            <p className="text-gray-700 text-lg">Low cost investment</p>
          </div>

          <div className="flex items-center gap-4">
            <FaRocket className="text-3xl text-red-500" />
            <p className="text-gray-700 text-lg">Quick and easy to implement</p>
          </div>

          <div className="flex items-center gap-4">
            <FaLock className="text-3xl text-purple-500" />
            <p className="text-gray-700 text-lg">Secure web-based 24/7 accessibility</p>
          </div>

          <div className="flex items-center gap-4">
            <FaCalendarCheck className="text-3xl text-orange-500" />
            <p className="text-gray-700 text-lg">Tracks all types of leave</p>
          </div>

          <div className="flex items-center gap-4">
            <FaChartLine className="text-3xl text-teal-500" />
            <p className="text-gray-700 text-lg">Full reporting functionality</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20" id='testimonials'>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-60">
